...
for dia in i:
    ...
    driver.find_element_by_xpath("//div[@data-value='8a5244704f859fdd014f8f3138fd0003']").click()
    time.sleep(5)
    ...
    df.to_excel(f'//Qsbrprd/qliksense/BRASIL/OUTRAS FONTES/PCR_INDUSTRIAL/Finance/CONCILIAÇÃO SIR/Automatização/PCR_IPATINGA_MASTERSAF/{vardata}_RECEBIMENTO_NFE.xlsx', index = False)
    
    """
    CARREGANDO A BASE TOTAL - PCR IPATINGA
    """
    dfbase = pd.read_excel(r"\\Qsbrprd\qliksense\BRASIL\OUTRAS FONTES\PCR_INDUSTRIAL\Finance\CONCILIAÇÃO SIR\Automatização\PCR_IPATINGA_MASTERSAF\BD\BD_PCR_IPATINGA.xlsx")
    
    """
    CARREGANDO A CARGA INCREMENTAL
    """
    dfcarga = pd.read_excel(fr"\\Qsbrprd\qliksense\BRASIL\OUTRAS FONTES\PCR_INDUSTRIAL\Finance\CONCILIAÇÃO SIR\Automatização\PCR_IPATINGA_MASTERSAF\{vardata}_RECEBIMENTO_NFE.xlsx")
    ...
    dffinal.to_excel(r"\\Qsbrprd\qliksense\BRASIL\OUTRAS FONTES\PCR_INDUSTRIAL\Finance\CONCILIAÇÃO SIR\Automatização\PCR_IPATINGA_MASTERSAF\BD\BD_PCR_IPATINGA.xlsx", index = False)
